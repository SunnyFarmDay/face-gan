...
### FACE-GAN:
I created a script to run the training, you can run by:
```bash
...
### FACE-GAN
Currently we use ffhq-dataset for training, you can download it from:
- [ffhq-dataset](https://github.com/NVlabs/ffhq-dataset)

The command to download the dataset is:
```
